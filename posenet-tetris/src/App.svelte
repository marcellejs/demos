<script>
  ...
  onMount(async () => {
    await tick();
    input.mount(posenetElt);
    browser.mount();
    sel.mount();
    selectFeatures.mount();
  });
...
<div id="left">
  ...
  <div style="display: flex">
    <div bind:this={posenetElt} id="posenet" style="width: 440px;" />
    <div id="controls">
  ...
  <div style="margin-top: 12px; display: flex; align-items: center;">
    <p>Select body parts:&nbsp;</p>
    <div id={selectFeatures.id} />
  </div>
</div>
